...
export function OAuthButtons({ mode = 'login' }: OAuthButtonsProps) {
  ...
  const handleGoogleAuth = () => {
    ...
    const googleAuthUrl = `https://accounts.google.com/o/oauth2/v2/auth?client_id=${clientId}&redirect_uri=${redirectUri}&response_type=code&scope=${scopes}&state=${state}`;
